...
CREATE VIEW PROJECT_BY_CUSTOMER AS
 SELECT C.CUST_ID AS CUSTOMER_ID, C.CUST_NAME AS CUSTOMER_NAME, P.PROG_NAME AS PROGRAM_NAME,P.PROG_ID PROGRAM_ID, P.PROG_START PROGRAM_START, P.PROG_END PROGRAM_END,P.PROG_STATUS PROGRAM_STATUS, P.AVG_PROD_WEEKLY, P.MAX_PROD_WEEKLY
