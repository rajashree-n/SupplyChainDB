...
INSERT INTO APPROVAL_DETAILS
    (PART_APPR_ID, PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (4001, 50000, 303, 'APPROVED', '2018/01/28', '2019/01/13', 123460, 1.6);

INSERT INTO APPROVAL_DETAILS
    (PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (50001, 305, 'APPROVED', '2014/11/02', '2015/07/20', 123459, 0.43);

INSERT INTO APPROVAL_DETAILS
    (PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (50002, 302, 'APPROVED', '2012/01/13', '2013/08/24', 123458, 2.16);
    
INSERT INTO APPROVAL_DETAILS
    (PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (50004, 302, 'PENDING', '2018/12/13', NULL, 123460, NULL);

INSERT INTO APPROVAL_DETAILS
    (PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (50003, 301, 'APPROVED', '2015/08/10', '2015/09/11', 123457, 1.22);

INSERT INTO APPROVAL_DETAILS
    (PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (50003, 301, 'DENIED', '2012/10/07', '2013/11/09', 123457, 1.10);
    
INSERT INTO APPROVAL_DETAILS
    (PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (50005, 304, 'PENDING', '2019/02/05', NULL, 123457, NULL);
    
INSERT INTO APPROVAL_DETAILS
    (PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (50007, 306, 'APPROVED', '2011/05/09', '2012/01/22', 123458, 0.96); 

INSERT INTO APPROVAL_DETAILS
    (PART_ID, SUPP_ID, APP_STATUS, SUBMIT_DATE, APP_DATE, SQE_REP, APP_COST)
    VALUES
    (50007, 307, 'PENDING', '2019/03/03', NULL, 123458, NULL);    
